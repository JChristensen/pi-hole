...
## Known issues
My router has a guest network configured as a subnet. It looks like guest DNS requests are routed to Pi-hole via the router, but that can probably be improved. I will update the procedure when I have a better handle on that.
